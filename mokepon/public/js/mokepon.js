...
const spanEmpates = document.getElementById('numero-empates')
...
function unirseAlJuego() {
    fetch("http://192.168.100.44:8080/unirse")
        .then(function (res) {
            if(res.ok) {
                res.text()
...
function seleccionarMokepon(mascotaJugador) {
    fetch(`http://192.168.100.44:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarAtaques() {
    fetch(`http://192.168.100.44:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },body: JSON.stringify({
...
function obtenerAtaques() {
    fetch(`http://192.168.100.44:8080/mokepon/${enemigoId}/ataques`)
        .then(function (res) {
            if(res.ok) {
                res.json()
...
function revisarVictorias() {
    if (victoriasJugador === victoriasEnemigo){
        crearMensajeFinal("Tuvieron un empate")
...
function enviarPosition(x, y) {
    fetch(`http://192.168.100.44:8080/mokepon/${jugadorId}/position`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
